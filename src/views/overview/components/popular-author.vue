  ...
  <a-spin :loading="loading" style="width: 100%">
    <a-card class="general-card" :header-style="{ paddingBottom: '14px' }">
      ...
      >
        <template #columns>
          <a-table-column
            :title="$t('overview.popularAuthor.column.ranking')"
            data-index="ranking"
          >
          </a-table-column>
          <a-table-column
            :title="$t('overview.popularAuthor.column.author')"
            data-index="author"
          >
          </a-table-column>
          <a-table-column
            :title="$t('overview.popularAuthor.column.content')"
          ...
          <a-table-column
            :title="$t('overview.popularAuthor.column.click')"
